...
namespace sms {
    ...
    SMSMessage::SMSMessage( ID id, SMSRequest req ): SMSRequest( req ) {
        ...
        taxes_map[ "11" ] = SMSTax( "Комсомольская правда - комплект", 1, 209 );
        taxes_map[ "13" ] = SMSTax( "Комсомольская правда - комплект", 3, 627 );
        taxes_map[ "16" ] = SMSTax( "Комсомольская правда - комплект", 6, 1254 );
        //--
        taxes_map[ "21" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 1, 159 );
        taxes_map[ "23" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 3, 477 );
        taxes_map[ "26" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 6, 954 );
        //--
        taxes_map[ "31" ] = SMSTax( "Комсомольская правда - еженедельник", 1, 70 );
        taxes_map[ "33" ] = SMSTax( "Комсомольская правда - еженедельник", 3, 210 );
        taxes_map[ "36" ] = SMSTax( "Комсомольская правда - еженедельник", 6, 439 );
        //--
        ...
        //--
        taxes_map[ "71" ] = SMSTax( "Телепрограмма", 1, 59 );
        taxes_map[ "73" ] = SMSTax( "Телепрограмма", 3, 177 );
        taxes_map[ "76" ] = SMSTax( "Телепрограмма", 6, 354 );
        //--
        ...
        //
	taxes_map[ "141" ] = SMSTax( "Великие художники (81-100 том)", 1, 4270 );
        //
	taxes_map[ "134" ] = SMSTax( "Великие художники (81-100 том)", 1, 4020 );
        //--
