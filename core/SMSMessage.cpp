...
namespace sms {
    ...
    SMSMessage::SMSMessage( ID id, SMSRequest req ): SMSRequest( req ) {
        ...
        taxes_map[ "11" ] = SMSTax( "Комсомольская правда - комплект", 1, 200 );
        taxes_map[ "13" ] = SMSTax( "Комсомольская правда - комплект", 3, 600 );
        taxes_map[ "16" ] = SMSTax( "Комсомольская правда - комплект", 6, 1200 );
        //--
        taxes_map[ "21" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 1, 140 );
        taxes_map[ "23" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 3, 420 );
        taxes_map[ "26" ] = SMSTax( "Комсомольская правда - ежедневный выпуск", 6, 840 );
        //--
        taxes_map[ "31" ] = SMSTax( "Комсомольская правда - еженедельник", 1, 70 );
        taxes_map[ "33" ] = SMSTax( "Комсомольская правда - еженедельник", 3, 210 );
        taxes_map[ "36" ] = SMSTax( "Комсомольская правда - еженедельник", 6, 420 );
        //--
        taxes_map[ "41" ] = SMSTax( "Советский спорт - ежедневная газета", 1, 345 );
        taxes_map[ "43" ] = SMSTax( "Советский спорт - ежедневная газета", 3, 1035 );
        taxes_map[ "46" ] = SMSTax( "Советский спорт - ежедневная газета", 6, 2070 );
        //--
        taxes_map[ "51" ] = SMSTax( "Советский спорт - Футбол", 1, 115 );
        taxes_map[ "53" ] = SMSTax( "Советский спорт - Футбол", 3, 345 );
        taxes_map[ "56" ] = SMSTax( "Советский спорт - Футбол", 6, 690 );
        //--
        taxes_map[ "61" ] = SMSTax( "Экспресс газета", 1, 90 );
        taxes_map[ "63" ] = SMSTax( "Экспресс газета", 3, 270 );
        taxes_map[ "66" ] = SMSTax( "Экспресс газета", 6, 540 );
        //--
        taxes_map[ "71" ] = SMSTax( "Телепрограмма", 1, 65 );
        taxes_map[ "73" ] = SMSTax( "Телепрограмма", 3, 195 );
        taxes_map[ "76" ] = SMSTax( "Телепрограмма", 6, 390 );
        //--
        ...
        //--
        taxes_map[ "111" ] = SMSTax( "Юношеская библиотека (1-25 том)", 1, 3230 );
